<?php
/**
 * Facebook Pixel Plugin FacebookApplyPosition class.
 *
 * This file contains the main logic for FacebookApplyPosition.
 *
 * @package FacebookPixelPlugin
 */

/**
 * Define FacebookApplyPosition class.
 *
 * @return void
 */
...
/**
 * FacebookApplyPosition class.
 */
class FacebookApplyPosition extends FacebookWordpressIntegrationBase {
    const TRACKING_NAME = 'apply-position';

    /**
     * Add hooks to inject the Contact Form 7 tracking code.
     *
     * Adds the following hooks:
     *  - apply_position: Triggers a server-side event when the form is submitted.
     *  - wp_footer: Injects the mail sent listener.
     */
    public static function inject_pixel_code() {
        add_filter( 'apply_position', array( __CLASS__, 'trackServerEvent' ) );
    ...
    /**
     * Injects a JavaScript listener for the 'applyPosition' event,
    ...
    <script type='text/javascript'>
        document.addEventListener( 'applyPosition', function( event ) {
...
FacebookApplyPosition::inject_pixel_code();